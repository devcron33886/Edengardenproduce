...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="text-black text-center" style="text-transform: capitalize;"> Update Order {{ $order->order_no }} status
            </h4>
        </div>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.orders.update', [$order->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <input type="number" class="form-control" name="updated_by_id" value="{{ Auth::user()->id }}">
